...
namespace cs.threephase
{
	...
	public class Edge3
	{
		static bool IS_64BIT_PLATFORM = true;

		static int N_SYM = 1538;
		public static int N_RAW = 20160;
		static int N_EPRUN = N_SYM * N_RAW;
		static int MAX_DEPTH = 10;

		static int[] prunValues = { 1, 4, 16, 55, 324, 1922, 12275, 77640, 485359, 2778197, 11742425, 27492416, 31002941, 31006080 };
		...
		static int[][] mvrot = new int[20 * 8][];
		static int[][] mvroto = new int[20 * 8][];
